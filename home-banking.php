...
<html class="no-js" lang="zxx">
   ...
   <body class="tp-bg-common-white-2 tp-magic-cursor">
      ...
      <header class="tp-header-height">
         ...
         <div class="tp-header-area header-transparent tp-header-2-wrap tp-bg-common-white">
      ...
      <div id="smooth-wrapper">
         <div id="smooth-content">
            ...
            <main>
               ...
               <!-- tp-hero-area-start -->
               <div class="tp-hero-area tp-hero-7-spacing p-relative tp-bg-grey-3">
                  <div class="tp-hero-7-shape">
                     <img src="assets/img/hero/hero-7/bottom-shape.png" alt="">
                  </div>
                  <div class="container-fluid container-1690">
                     <div class="row gx-25">
                        <div class="col-lg-12">
                           <div class="tp-hero-7-slider-wrap mb-50">
                              <div class="swiper-container tp-hero-7-slider-active">
                                 <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                       <div class="tp-hero-7-thumb anim-zoomin-wrap not-hide-cursor" data-cursor="Drag">
                                          <div class="anim-zoomin fix">
                                             <img src="assets/img/hero/hero-7/thumb.jpg" alt="">
                                          </div>
                                       </div>
                                    </div>
                                    <div class="swiper-slide">
                                       <div class="tp-hero-7-thumb anim-zoomin-wrap not-hide-cursor" data-cursor="Drag">
                                          <div class="anim-zoomin fix">
                                             <img src="assets/img/hero/hero-7/thumb-2.jpg" alt="">
                                          </div>
                                       </div>
                                    </div>
                                    <div class="swiper-slide">
                                       <div class="tp-hero-7-thumb anim-zoomin-wrap not-hide-cursor" data-cursor="Drag">
                                          <div class="anim-zoomin fix">
                                             <img src="assets/img/hero/hero-7/thumb-3.jpg" alt="">
                                          </div>
                                       </div>
                                    </div>
                                    <div class="swiper-slide">
                                       <div class="tp-hero-7-thumb not-hide-cursor" data-cursor="Drag">
                                          <img src="assets/img/hero/hero-7/thumb-4.jpg" alt="">
                                       </div>
                                    </div>
                                    <div class="swiper-slide">
                                       <div class="tp-hero-7-thumb not-hide-cursor" data-cursor="Drag">
                                          <img src="assets/img/hero/hero-7/thumb-5.jpg" alt="">
                                       </div>
                                    </div>
                                    <div class="swiper-slide">
                                       <div class="tp-hero-7-thumb not-hide-cursor" data-cursor="Drag">
                                          <img src="assets/img/hero/hero-7/thumb-6.jpg" alt="">
                                       </div>
                                    </div>
                                 </div>
                              </div>
                        ...
                        <div class="col-lg-7">
                           <div class="tp-hero-7-title-wrap mb-30">
                              <h2 class="fs-60 ls-m-4 lh-1 mb-20 fs-xl-40 fs-sm-36 tp-text-revel-anim">Shaping the future of banking<br> for the next  <span class="text-italic fw-400 tp-ff-heading">generation.</span> </h2>
                           </div>
                        </div>
                        <div class="col-lg-5">
                           <div class="tp-hero-7-text ml-60 mb-30 wow img-custom-anim-right" data-wow-duration="1.5s" data-wow-delay="0.2s">
                              <p class="mb-30">HR consulting content encompasses a wide range of topics related to managing an
                                 organization's human resources, including recruitment</p>
               ...
               <div class="tp-feature-area tp-feature-7-spacing tp-bg-theme-primary">
                  <div class="container-fluid container-1690">
                     <div class="row">
                        <div class="col-lg-4 col-md-6">
                           <div class="tp-feature-7-item tp-feature-7-item-border d-flex mb-40 wow fadeInLeft" data-wow-delay=".3s" data-wow-duration=".9s">
                              <span class="tp-feature-7-icon fs-24 fw-500 ls-m-2 tp-text-common-white rounded-circle d-inline-block mr-35">01</span>
                              <div class="tp-feature-7-content">
                                 <h3 class="fw-500 fs-24 ls-m-2 tp-text-common-white">Accredited by the industry</h3>
                                 <p class="lh-26 tp-text-grey-3 mb-0">Industry accreditation is a mark of credibility
                        ...
                        <div class="col-lg-4 col-md-6">
                           <div class="tp-feature-7-item tp-feature-7-item-border d-flex mb-40 wow fadeInLeft" data-wow-delay=".5s" data-wow-duration=".9s">
                              <span class="tp-feature-7-icon fs-24 fw-500 ls-m-2 tp-text-common-white rounded-circle d-inline-block mr-35">02</span>
                              <div class="tp-feature-7-content">
                                 <h3 class="fw-500 fs-24 ls-m-2 tp-text-common-white">Truthfulness & strong ethics</h3>
                                 <p class="lh-26 tp-text-grey-3 mb-0">Industry accreditation is a mark of credibility
                                    professionalism, and excellence. It signifies
                                    that a business, organization.</p>
                              </div>
                        ...
                        <div class="col-lg-4 col-md-6">
                           <div class="tp-feature-7-item mr-80 d-flex mb-40 wow fadeInLeft" data-wow-delay=".7s" data-wow-duration=".9s">
                              <span class="tp-feature-7-icon fs-24 fw-500 ls-m-2 tp-text-common-white rounded-circle d-inline-block mr-35">03</span>
                              <div class="tp-feature-7-content">
                                 <h3 class="fw-500 fs-24 ls-m-2 tp-text-common-white">Reducing expenses</h3>
                                 <p class="lh-26 tp-text-grey-3 mb-0">Industry accreditation is a mark of credibility
                                    professionalism, and excellence. It signifies
                                    that a business, organization.</p>
                              </div>
               ...
               <div class="tp-counter-area tp-counter-7-spacing pb-140">
                  <div class="container-fluid container-1690">
                     <div class="row gx-0">
                        <div class="col-xl-3 col-lg-6 col-md-6">
                           <div class="tp-counter-7-item tp-counter-7-item-border tpshake-wrap tp-bg-common-white h-100">
                              <span class="tp-counter-7-icon tpshake d-inline-block mb-195">
                                 <svg width="72" height="74" viewBox="0 0 72 74" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <rect x="14.7031" y="1" width="20.8395" height="20.8395" fill="white" stroke="#1F3130" stroke-width="2" />
                                    <rect x="28.4082" y="11.963" width="20.8395" height="20.8395" fill="white" stroke="#1F3130" stroke-width="2" />
                                    <rect x="42.1113" y="16.5312" width="20.8395" height="16.2716" fill="white" stroke="#1F3130" stroke-width="2" />
                                    <rect x="49.4199" y="26.5802" width="20.8395" height="20.8395" fill="white" stroke="#1F3130" stroke-width="2" />
                                    <rect x="37.543" y="32.9756" width="20.8395" height="20.8395" fill="white" stroke="#1F3130" stroke-width="2" />
                                    <rect x="22.9258" y="39.3701" width="20.8395" height="20.8395" fill="white" stroke="#1F3130" stroke-width="2" />
                                    <rect x="11.9629" y="45.7654" width="20.8395" height="20.8395" fill="white" stroke="#1F3130" stroke-width="2" />
                                    <rect x="1" y="52.1602" width="20.8395" height="20.8395" fill="white" stroke="#1F3130" stroke-width="2" />
                                 </svg>
                              </span>
                              <h3 class="fw-600 fs-26 fs-xl-22 ls-m-3 tp-text-theme-primary">Over 1,000 monthly
                                 transfers managed
                                 seamlessly.</h3>
                           </div>
                        </div>
                        <div class="col-xl-3 col-lg-6 col-md-6">
                           <div class="tp-counter-7-item bg-position tpshake-wrap h-100 d-flex justify-content-xl-end align-items-end" data-background="assets/img/counter/counter-7/thumb.jpg">
                              <div class="pt-150">
                                 <span class="tp-counter-7-icon tpshake d-inline-block mb-25">
                                    <svg width="74" height="74" viewBox="0 0 74 74" fill="none" xmlns="http://www.w3.org/2000/svg">
                                       <circle cx="37" cy="37" r="36" stroke="white" stroke-width="2" />
                                       <circle cx="37" cy="32.375" r="31.375" stroke="white" stroke-width="2" />
                                       <circle cx="45.3242" cy="37" r="26.75" stroke="white" stroke-width="2" />
                                    </svg>
                                 </span>
                                 <h3 class="fw-600 fs-26 fs-xl-22 ls-m-3 tp-text-common-white">Over 450<br> clients supported worldwide.</h3>
                              </div>
                           </div>
                        </div>
                        <div class="col-xl-3 col-lg-6 col-md-6">
                           <div class="tp-counter-7-item tpshake-wrap tp-bg-grey-3 h-100">
                              <span class="tp-counter-7-icon tpshake d-inline-block mb-195">
                                 <svg width="80" height="78" viewBox="0 0 80 78" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <path d="M42.8496 75.5371V22.3496" stroke="#1F3130" stroke-width="2" />
                                    <path d="M49.2492 16.8004C49.2492 20.335 46.3838 23.2004 42.8492 23.2004C39.3146 23.2004 36.4492 20.335 36.4492 16.8004C36.4492 13.2658 39.3146 10.4004 42.8492 10.4004C46.3838 10.4004 49.2492 13.2658 49.2492 16.8004Z" stroke="#1F3130" stroke-width="2" />
                                 </svg>
                              </span>
                              <h3 class="fw-600 fs-26 fs-xl-22 ls-m-3 tp-text-theme-primary">Over 20 years<br>
                                 of expertise in<br>
                                 the industry.</h3>
                           </div>
                        </div>
                        <div class="col-xl-3 col-lg-6 col-md-6">
                           <div class="tp-counter-7-item tp-counter-7-item-border-2 tpshake-wrap tp-bg-theme-secondary h-100">
                              <span class="tp-counter-7-icon tpshake d-inline-block mb-195">
                                 <svg width="75" height="74" viewBox="0 0 75 74" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <path d="M73.9258 46.25C73.9258 61.0236 61.9494 73 47.1758 73C32.4022 73 20.4258 61.0236 20.4258 46.25C20.4258 31.4764 32.4022 19.5 47.1758 19.5C61.9494 19.5 73.9258 31.4764 73.9258 46.25Z" stroke="#1F3130" stroke-width="2" />
                                    <path d="M21.7383 40.2377H45.3258L36.5383 33.7627" stroke="#1F3130" stroke-width="2" />
                                 </svg>
                              </span>
                              <h3 class="fw-600 fs-26 fs-xl-22 ls-m-3 tp-text-theme-primary">Over 850+ customized
                                 strategies developed.</h3>
                           </div>
                        </div>
                     </div>
                  </div>
                        ...
                        <div class="row gx-90">
                           <div class="col-lg-6 mb-30 tp-counter-3-border">
                              <div class="tp-about-3-title-wrap mr-60">
                                 ...
                                 <h2 class="mb-25 fs-xl-40 fs-sm-36 tp-text-revel-anim">Solving small will power a quality of progress <span class="text-italic fw-400 tp-ff-heading">banking strategy</span> </h2>
                              ...
                              <div class="tp-about-3-content ml-35">
                                 <div class="row align-items-center">
                                    <div class="col-xxl-4 col-xl-5 col-lg-12 col-md-5">
                                       <div class="tp-about-3-list tp-bg-grey-3">
                                          <ul>
               ...
               <div class="tp-service-area pb-110 pt-135">
                  <div class="container">
                     <div class="row justify-content-center">
                        <div class="col-xl-9">
                           <div class="tp-service-2-title-wrap mb-50 text-center">
                              <span class="fw-500 fs-16 tp-text-grey-1 mb-10 d-inline-block">Explore our services</span>
                              <h2 class="mb-25 fs-xl-40 fs-sm-36 tp-text-revel-anim">Service for your<span class="text-italic fw-400 tp-ff-heading"> development</span> </h2>
                           </div>
                        </div>
                     </div>
                     <div class="row">
                        <div class="col-lg-4 col-md-6">
                           <div class="tp-service-2-wrap p-relative fix mb-30 wow fadeInLeft" data-wow-delay=".3s" data-wow-duration=".9s">
                              <div class="tp-service-2-thumb tp-round-4">
                                 <img class="w-100 tp-round-4" src="assets/img/service/service-7/thumb.jpg" alt="">
                              </div>
                              <div class="tp-service-2-content p-absolute">
                                 <div class="tp-service-2-content-top d-flex align-items-center">
                                    ...
                                    <span class="fw-500 fs-26 ls-m-2 tp-text-common-white"><a href="service-details.php" class="underline-white hover-text-white">Finance<br> insurance</a></span>
                                 </div>
                        ...
                        <div class="col-lg-4 col-md-6">
                           <div class="tp-service-2-wrap p-relative fix mb-30 wow fadeInUp" data-wow-delay=".3s" data-wow-duration=".9s">
                              <div class="tp-service-2-thumb tp-round-4">
                                 <img class="w-100 tp-round-4" src="assets/img/service//service-7/thumb-2.jpg" alt="">
                              </div>
                              <div class="tp-service-2-content p-absolute">
                                 <div class="tp-service-2-content-top d-flex align-items-center">
                                    <span class="mr-30">
                                    ...
                                    <span class="fw-500 fs-26 ls-m-2 tp-text-common-white"><a href="service-details.php" class="underline-white hover-text-white">Startup<br>  insurance</a></span>
                                 </div>
                                 <div class="tp-service-2-content-bottom pt-20 mt-15">
                                    <p class="mb-0 tp-text-grey-3 lh-24">Marketing consulting involves providing
                                       strategies to businesses to improve</p>
                        ...
                        <div class="col-lg-4 col-md-6">
                           <div class="tp-service-2-wrap p-relative fix mb-30 wow fadeInRight" data-wow-delay=".3s" data-wow-duration=".9s">
                              <div class="tp-service-2-thumb tp-round-4">
                              ...
                              <div class="tp-service-2-content p-absolute">
                                 <div class="tp-service-2-content-top d-flex align-items-center">
                                    ...
                                    <span class="fw-500 fs-26 ls-m-2 tp-text-common-white"><a href="service-details.php" class="underline-white hover-text-white">Business<br> insurance</a></span>
                                 </div>
                                 <div class="tp-service-2-content-bottom pt-20 mt-15">
                                    <p class="mb-0 tp-text-grey-3 lh-24">Marketing consulting involves providing
                                       strategies to businesses to improve</p>
               ...
               <div class="tp-process-area tp-bg-grey-3 fix">
                  <div class="container-fluid p-0">
                     <div class="row">
                        <div class="col-lg-6">
                           <div class="tp-process-7-thumb h-100 image-reveal fix">
                              <img class="w-100" src="assets/img/process/process-7/thumb.jpg" alt="">
                           </div>
                        </div>
                        <div class="col-lg-6">
                           <div class="tp-process-7-content pt-130 pb-100">
                              <h2 class="mb-25 fs-xl-40 fs-sm-36 mb-60 tp-text-revel-anim">How does banking <br> consulting  <span class="text-italic fw-400 tp-ff-heading"> work</span></h2>
                              <div class="tp-process-7-list-wrap">
                                 <div class="tp-process-7-list pl-80">
                                    <div class="tp-process-7-item tpshake-wrap-2 mb-55">
                                       <div class="tp-process-7-icon d-flex mb-15">
                                          <span class="d-inline-block mr-30 tpshake-2">
                                             <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M12.2099 12.9624L8.05132 13.2837C6.89417 13.3731 5.86358 13.9796 5.22365 14.9475L0.427708 22.2011C-0.0576325 22.9352 -0.134788 23.8538 0.221178 24.6586C0.577239 25.4633 1.30895 26.0241 2.17848 26.1589L5.98611 26.7485C6.87682 22.0217 9.00906 17.3065 12.2099 12.9624Z" fill="#506767" />
                                                <path d="M21.252 42.0138L21.8417 45.8214C21.9764 46.6909 22.5373 47.4227 23.3419 47.7786C23.6767 47.9267 24.0311 47.9999 24.3837 47.9999C24.8789 47.9999 25.3707 47.8556 25.7995 47.5721L33.0532 42.7762C34.0212 42.1362 34.6277 41.1055 34.7169 39.9486L35.0382 35.79C30.694 38.9909 25.9789 41.1232 21.252 42.0138Z" fill="#506767" />
                                                <path d="M19.819 39.3749C19.9512 39.3749 20.0841 39.364 20.2167 39.3419C22.1971 39.0108 24.1058 38.453 25.9266 37.7228L10.2771 22.0732C9.54694 23.8939 8.98913 25.8027 8.658 27.7831C8.5275 28.5638 8.78935 29.3591 9.34894 29.9188L18.0811 38.651C18.5458 39.1155 19.1728 39.3749 19.819 39.3749Z" fill="#506767" />
                                                <path d="M44.1731 21.2814C48.0026 13.8776 48.1445 6.05368 47.9443 2.38433C47.8758 1.12706 46.8734 0.124687 45.6161 0.0561559C45.0186 0.0235311 44.3105 0 43.5124 0C39.4094 0 32.9171 0.621465 26.719 3.82741C21.7932 6.37524 15.3342 11.9853 11.5234 19.3579C11.5684 19.3931 11.6124 19.4304 11.6538 19.4718L28.5287 36.3467C28.5702 36.3882 28.6074 36.432 28.6425 36.4771C36.0152 32.6662 41.6252 26.2072 44.1731 21.2814ZM27.9094 10.1474C30.6508 7.40611 35.1114 7.40583 37.853 10.1474C39.181 11.4754 39.9124 13.2412 39.9124 15.1192C39.9124 16.9973 39.181 18.7631 37.853 20.0911C36.4824 21.4616 34.6815 22.147 32.8812 22.1472C31.0804 22.1473 29.2803 21.462 27.9094 20.0911C26.5814 18.7631 25.8499 16.9973 25.8499 15.1192C25.8499 13.2412 26.5814 11.4754 27.9094 10.1474Z" fill="#506767" />
                                                <path d="M29.8977 18.1022C31.5426 19.747 34.2192 19.7471 35.864 18.1022C36.6608 17.3053 37.0996 16.2459 37.0996 15.119C37.0996 13.9922 36.6608 12.9328 35.864 12.136C35.0416 11.3135 33.9612 10.9023 32.8809 10.9023C31.8006 10.9023 30.7202 11.3135 29.8978 12.136C29.101 12.9328 28.6621 13.9922 28.6621 15.119C28.6621 16.2459 29.101 17.3054 29.8977 18.1022Z" fill="#506767" />
                                                <path d="M1.4356 39.5566C1.7955 39.5566 2.15541 39.4194 2.42991 39.1447L7.02114 34.5534C7.57032 34.0043 7.57032 33.1139 7.02114 32.5647C6.47204 32.0155 5.5816 32.0155 5.03241 32.5647L0.441188 37.1559C-0.108 37.7051 -0.108 38.5955 0.441188 39.1447C0.715782 39.4193 1.07569 39.5566 1.4356 39.5566Z" fill="#506767" />
                                                <path d="M11.2277 36.7722C10.6786 36.2231 9.78813 36.2231 9.23894 36.7722L0.411891 45.5993C-0.137297 46.1485 -0.137297 47.0388 0.411891 47.588C0.686485 47.8626 1.04639 47.9999 1.4063 47.9999C1.76621 47.9999 2.12611 47.8626 2.40061 47.5879L11.2276 38.761C11.7768 38.2118 11.7768 37.3214 11.2277 36.7722Z" fill="#506767" />
                                                <path d="M13.4464 40.9798L8.85525 45.571C8.30606 46.1202 8.30606 47.0105 8.85525 47.5597C9.12984 47.8343 9.48975 47.9717 9.84956 47.9717C10.2094 47.9717 10.5694 47.8344 10.8439 47.5597L15.4351 42.9685C15.9843 42.4193 15.9843 41.529 15.4351 40.9798C14.886 40.4306 13.9956 40.4306 13.4464 40.9798Z" fill="#506767" />
                                             </svg>
                                          </span>
                                          <h4 class="fs-24 ls-m-3 "><a href="#">Digital transformation and fintech integration</a></h4>
                                       </div>
                                       <p>Fintech has gone through an evolutionary shift during the
                                          past few  years. This shift is due to the convergence of
                                          digital transformation and the widespread</p>
                                    </div>
                                    <div class="tp-process-7-item tpshake-wrap-2 mb-55">
                                       <div class="tp-process-7-icon d-flex mb-15">
                                          <span class="d-inline-block mr-30 tpshake-2">
                                             <svg width="36" height="48" viewBox="0 0 36 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M24.63 15.79C21.87 15.79 19.63 13.55 19.63 10.79V0H3C1.34 0 0 1.34 0 3V45C0 46.66 1.35 48 3 48H32.42C34.08 48 35.42 46.66 35.42 45V15.79H24.63ZM16.14 20.95L21.41 26.22L27.19 20.44C27.58 20.05 28.21 20.05 28.6 20.44C28.99 20.83 28.99 21.47 28.6 21.86L22.12 28.34C21.73 28.73 21.09 28.73 20.7 28.34L15.43 23.07L6.89 31.61C6.7 31.81 6.44 31.9 6.19 31.9C5.93 31.9 5.68 31.81 5.48 31.61C5.09 31.22 5.09 30.59 5.48 30.2L14.73 20.95C15.12 20.56 15.75 20.56 16.14 20.95ZM5.92 10.82C4.478 9.6 4.83 6.006 8.43 5.82V5.07H9.38V5.83C10.48 5.92 11.52 6.31 12.51 6.97L11.53 8.37C10.87 7.89 10.15 7.59 9.38 7.49V10.32C9.828 10.32 11.301 10.838 11.97 11.42C13.396 12.635 13.235 16.248 9.38 16.47V17.55H8.43V16.46C7.05 16.33 5.8 15.77 4.71 14.82L5.82 13.5C6.65 14.24 7.52 14.67 8.43 14.82V11.89C7.29 11.62 6.46 11.26 5.92 10.82ZM8.38 44H4V34.99H8.38V44ZM16.06 44H11.68V33.09H16.06V44ZM23.74 44H19.36V38.26H23.74V44ZM31.42 44H27.04V28.02H31.42V44ZM9.38 12.16V14.86C11.197 14.675 11.813 12.798 9.38 12.16ZM8.43 7.44C6.992 7.536 6.596 8.806 7.26 9.47C7.48 9.68 7.87 9.86 8.43 10.04V7.44Z" fill="#506767" />
                                             </svg>
                                          </span>
                                          <h4 class="fs-24 ls-m-3 "><a href="#">Risk management and compliance</a></h4>
                                       </div>
                                       <p>Risk management is a broad practice that includes
                                          compliance management, which focuses on risks 
                                          that arise from non-compliance</p>
                                    </div>
                                    <div class="tp-process-7-item tpshake-wrap-2 mb-55">
                                       <div class="tp-process-7-icon d-flex mb-15">
                                          <span class="d-inline-block mr-30 tpshake-2">
                                             <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M0 32.25V47.9999H8.99995V30.75H1.49999C1.10217 30.75 0.720641 30.908 0.439338 31.1893C0.158034 31.4706 0 31.8522 0 32.25Z" fill="#506767" />
                                                <path d="M10.5 24V47.9999H19.5V22.5H12C11.6022 22.5 11.2206 22.658 10.9393 22.9393C10.658 23.2206 10.5 23.6022 10.5 24Z" fill="#506767" />
                                                <path d="M46.7163 11.6014L33.9931 0.375246C33.7191 0.133436 33.3662 0 33.0007 0C32.6352 0 32.2823 0.133436 32.0083 0.375246L19.2856 11.6014C19.0782 11.7802 18.9225 12.0114 18.8348 12.2708C18.747 12.5302 18.7303 12.8084 18.7865 13.0764C18.8607 13.4094 19.0462 13.7072 19.3124 13.9206C19.5786 14.134 19.9096 14.2502 20.2508 14.2502H21.0008V48H45.0006V14.2502H45.7506C46.0918 14.2502 46.4228 14.134 46.689 13.9206C46.9552 13.7072 47.1407 13.4094 47.2149 13.0764C47.2711 12.8084 47.2545 12.5303 47.1668 12.2709C47.0791 12.0115 46.9236 11.7803 46.7163 11.6014ZM31.5007 24.0001H34.5007C35.6942 24.0001 36.8387 24.4742 37.6827 25.3181C38.5266 26.162 39.0007 27.3066 39.0007 28.5001C39.0007 29.6936 38.5266 30.8382 37.6827 31.6821C36.8387 32.526 35.6942 33.0001 34.5007 33.0001V34.5001H31.5007V33.0001C30.3077 32.9987 29.1638 32.5242 28.3202 31.6806C27.4766 30.837 27.0021 29.6932 27.0007 28.5001H30.0007C30.0012 28.8978 30.1594 29.279 30.4406 29.5602C30.7218 29.8414 31.103 29.9996 31.5007 30.0001H34.5007C34.8985 30.0001 35.28 29.8421 35.5613 29.5608C35.8427 29.2795 36.0007 28.8979 36.0007 28.5001C36.0007 28.1023 35.8427 27.7208 35.5613 27.4394C35.28 27.1581 34.8985 27.0001 34.5007 27.0001H31.5007C30.3072 27.0001 29.1627 26.526 28.3187 25.6821C27.4748 24.8382 27.0007 23.6936 27.0007 22.5001C27.0007 21.3067 27.4748 20.1621 28.3187 19.3182C29.1627 18.4743 30.3072 18.0002 31.5007 18.0002V16.5002H34.5007V18.0002C35.6938 18.0015 36.8376 18.476 37.6812 19.3196C38.5248 20.1633 38.9993 21.3071 39.0007 22.5001H36.0007C36.0002 22.1025 35.842 21.7212 35.5608 21.44C35.2796 21.1588 34.8984 21.0006 34.5007 21.0001H31.5007C31.1029 21.0001 30.7214 21.1582 30.4401 21.4395C30.1587 21.7208 30.0007 22.1023 30.0007 22.5001C30.0007 22.898 30.1587 23.2795 30.4401 23.5608C30.7214 23.8421 31.1029 24.0001 31.5007 24.0001Z" fill="#506767" />
                                             </svg>
                                          </span>
                                          <h4 class="fs-24 ls-m-3 "><a href="#">Operational efficiency and cost optimization</a></h4>
                                       </div>
                                       <p>Operational efficiency refers to streamlining business
                                          processes to maximize productivity and  output
                                    ...
                                    <div class="tp-process-7-item tpshake-wrap-2 mb-55">
                                       <div class="tp-process-7-icon d-flex mb-15">
                                          <span class="d-inline-block mr-30 tpshake-2">
                                             <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M48 45.1875H45.1875V16.875H36.6562V45.1875H33.8438V28.125H25.4062V45.1875H22.5938V22.5H14.1562V45.1875H11.3438V30.9375H2.8125V45.1875H0V48H48V45.1875Z" fill="#506767" />
                                                <path d="M48.0001 11.25V0H36.6563V2.8125H43.199L29.6251 16.2927L18.3751 5.04272L0.412109 22.912L2.40055 24.9005L18.3751 9.01978L29.6251 20.2698L45.1876 4.80103V11.25H48.0001Z" fill="#506767" />
                                             </svg>
                                          </span>
                                          <h4 class="fs-24 ls-m-3 "><a href="#">Customer experience and growth strategies</a></h4>
                                       </div>
                                       <p>Fintech has gone through an evolutionary shift during the
                                          past few  years. This shift is due to the convergence of
                                          digital transformation and the widespread</p>
                                    </div>
                                    <div class="tp-process-7-item tpshake-wrap-2 ">
                                       <div class="tp-process-7-icon d-flex mb-15">
                                          <span class="d-inline-block mr-30 tpshake-2">
                                             <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M12.2099 12.9624L8.05132 13.2837C6.89417 13.3731 5.86358 13.9796 5.22365 14.9475L0.427708 22.2011C-0.0576325 22.9352 -0.134788 23.8538 0.221178 24.6586C0.577239 25.4633 1.30895 26.0241 2.17848 26.1589L5.98611 26.7485C6.87682 22.0217 9.00906 17.3065 12.2099 12.9624Z" fill="#506767" />
               ...
               <div class="tp-testimonial-area tp-bg-common-white pt-140 pb-110">
                  <div class="container">
                     <div class="row">
                        <div class="col-lg-4">
                        ...
                        <div class="col-lg-8">
                           <div class="tp-testimonial-2-slider p-relative mb-30">
                              ...
                              <h2 class="mb-25 fs-sm-36 tp-text-theme-primary tp-text-revel-anim">What our customer <span class="text-italic fw-400 tp-ff-heading">say?</span> </h2>
               ...
               <div class="tp-project-area tp-project-2-animate-tab tp-bg-grey-3 pt-135 pb-140">
                  <div class="container">
                     <div class="row">
                        <div class="col-lg-12">
                           <div class="tp-project-5-title-wrap text-center mb-55">
                              ...
                              <h2 class="mb-20 fs-xl-40 fs-sm-36 tp-text-revel-anim">Highlighted examples <span class="text-italic fw-400 tp-ff-heading">of our work</span> </h2>
                           </div>
                        </div>
                     </div>
                     <div class="row justify-content-center">
                              ...
                              <div class="tab-content p-relative">
                                 <div class="tab-pane active show" id="cases" role="tabpanel">
                                    <div class="swiper-container tp-project-slider-active">
                                       <div class="swiper-wrapper">
                                          <div class="swiper-slide">
                                             <div class="tp-project-2-wrap tp-project-5-wrap tp-project-6-wrap p-relative fix not-hide-cursor" data-cursor="Drag">
               ...
               <div class="tp-industry-area tp-industry-7-spacing tp-bg-theme-primary pt-135">
                  <div class="container">
                     <div class="row justify-content-center">
                        <div class="col-lg-6 col-md-8">
                           <div class="tp-industry-section-title-wrap text-center mb-55">
                              <span class="tp-section-subtitle fw-500 tp-text-common-white mb-10"> Our industries </span>
                              <h2 class="mb-20 fs-xl-40 fs-sm-36 tp-text-common-white tp-text-revel-anim"> Industry we <span class="text-italic fw-400 tp-ff-heading">always help</span></h2>
                           </div>
                        </div>
                     </div>
                     <div class="row">
                        <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInLeft" data-wow-delay=".3s" data-wow-duration=".9s">
                           <div class="tp-industry-content tp-industry-7-content d-flex align-items-center tp-round-4 mb-30">
                              <span class="tp-industry-icon d-inline-block tp-text-common-white">
                              ...
                              <h5 class="fw-500 fs-18 mb-0 ml-25 pt-10 pb-10 pr-10 tp-text-common-white">Financial<br> service</h5>
                           </div>
                        </div>
                        <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInLeft" data-wow-delay=".5s" data-wow-duration=".9s">
                           <div class="tp-industry-content tp-industry-7-content d-flex align-items-center tp-round-4 mb-30">
                              <span class="tp-industry-icon d-inline-block tp-text-common-white">
                              ...
                              <div class="border-right"></div>
                              <h5 class="fw-500 fs-18 mb-0 ml-25 pt-10 pb-10 pr-10 tp-text-common-white">Advanced<br> manufacturing</h5>
                           </div>
                        </div>
                        <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInLeft" data-wow-delay=".7s" data-wow-duration=".9s">
                           <div class="tp-industry-content tp-industry-7-content d-flex align-items-center tp-round-4 mb-30">
                              <span class="tp-industry-icon d-inline-block tp-text-common-white">
                                 <svg width="45" height="45" viewBox="0 0 45 45" fill="none" xmlns="http://www.w3.org/2000/svg">
                              ...
                              <div class="border-right"></div>
                              <h5 class="fw-500 fs-18 mb-0 ml-25 pt-10 pb-10 pr-10 tp-text-common-white">Automotive<br> and mobility</h5>
                           </div>
                        </div>
                        <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInLeft" data-wow-delay=".9s" data-wow-duration=".9s">
                           <div class="tp-industry-content tp-industry-7-content d-flex align-items-center tp-round-4 mb-30">
                              <span class="tp-industry-icon d-inline-block tp-text-common-white">
                                 <svg width="44" height="44" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg">
                              ...
                              <div class="border-right"></div>
                              <h5 class="fw-500 fs-18 mb-0 ml-25 pt-10 pb-10 pr-10 tp-text-common-white">Energy &<br> natural resources</h5>
                           </div>
                        </div>
                     </div>
                     <div class="row justify-content-center">
                        <div class="col-xl-9">
                           <div class="row justify-content-center">
                              <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInLeft" data-wow-delay=".3s" data-wow-duration=".9s">
                                 <div class="tp-industry-content tp-industry-7-content d-flex align-items-center tp-round-4 mb-30">
                                    <span class="tp-industry-icon d-inline-block tp-text-common-white">
                                       <svg width="44" height="44" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <div class="border-right"></div>
                                    <h5 class="fw-500 fs-18 mb-0 ml-25 pt-10 pb-10 pr-10 tp-text-common-white">Banking and<br>capital markets</h5>
                                 </div>
                              </div>
                              <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInLeft" data-wow-delay=".5s" data-wow-duration=".9s">
                                 <div class="tp-industry-content tp-industry-7-content d-flex align-items-center tp-round-4 mb-30">
                                    <span class="tp-industry-icon d-inline-block tp-text-common-white">
                                       <svg width="44" height="44" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <div class="border-right"></div>
                                    <h5 class="fw-500 fs-18 mb-0 ml-25 pt-10 pb-10 pr-10 tp-text-common-white">AHealth care<br> and life insurance</h5>
                                 </div>
                              </div>
                              <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInLeft" data-wow-delay=".7s" data-wow-duration=".9s">
                                 <div class="tp-industry-content tp-industry-7-content d-flex align-items-center tp-round-4 mb-30">
                                    <span class="tp-industry-icon d-inline-block tp-text-common-white">
                                       <svg width="44" height="44" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <div class="border-right"></div>
                                    <h5 class="fw-500 fs-18 mb-0 ml-25 pt-10 pb-10 pr-10 tp-text-common-white">Social and<br> public sectors</h5>
                                 </div>
                              </div>
                              <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInLeft" data-wow-delay=".9s" data-wow-duration=".9s">
                                 <div class="tp-industry-content tp-industry-7-content d-flex align-items-center tp-round-4 mb-30">
                                    <span class="tp-industry-icon d-inline-block tp-text-common-white">
                                       <svg width="44" height="44" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <div class="border-right"></div>
                                    <h5 class="fw-500 fs-18 mb-0 ml-25 pt-10 pb-10 pr-10 tp-text-common-white">Digital media<br> and entertainment</h5>
                                 </div>
                              </div>
                              <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInLeft" data-wow-delay=".9s" data-wow-duration=".9s">
                                 <div class="tp-industry-content tp-industry-7-content d-flex align-items-center tp-round-4 mb-30">
                                    ...
                                    <div class="border-right"></div>
                                    <h5 class="fw-500 fs-18 mb-0 ml-25 pt-10 pb-10 pr-10 tp-text-common-white">Forest products<br> paper & packaging</h5>
                                 </div>
                              </div>
                           </div>
                        </div>
               ...
               <div class="tp-success-area tp-success-7-spacing fix pb-40">
                  <div class="container-fluid p-0">
                     <div class="row justify-content-end">
                        <div class="col-xxl-10 col-xl-11">
                           <div class="tp-success-7-wrap tp-testimonial-3-content bg-position p-relative" data-background="assets/img/suscess/thumb.jpg">
                              <div class="tp-success-7-content">
                                 <img class="mb-35" src="assets/img/suscess/graph.png" alt="">
                                 <h2 class="fw-600 fs-80 ls-m-3 tp-text-common-white"><span data-purecounter-duration="1" data-purecounter-end="256"  class="purecounter">0</span>k</h2>
                                 <h6 class="fw-500 fs-26 ls-m-2 tp-text-common-white mb-40">Growth focused solution of banking consulting</h6>
               ...
               <!-- tp-video-area-start -->
               <div class="tp-video-area pb-110">
                  <div class="container">
                     <div class="row">
                        <div class="col-lg-7 mb-30">
                           <div class="tp-video-7-wrap anim-zoomin-wrap p-relative mr-80">
                              <div class="tp-gsap-image-position anim-zoomin fix">
                                 <img class="tp-round-4 tp-gsap-image-cover" src="assets/img/suscess/thumb-2.jpg" alt="">
                              </div>
                              <a class="tp-about-bottom-video-btn popup-video tp-video-7-icon" href="https://www.youtube.com/watch?v=go7QYaQR494">
                                 <span>
                        ...
                        <div class="col-lg-5 mb-30">
                           <div class="tp-video-7-content">
                              <span class="d-inline-block mb-30">
                                 <svg width="60" height="60" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <circle cx="30" cy="30" r="29" stroke="#1F3130" stroke-width="2" />
                                    <circle cx="30" cy="26.25" r="25.25" stroke="#1F3130" stroke-width="2" />
                                    <circle cx="36.75" cy="30" r="21.5" stroke="#1F3130" stroke-width="2" />
                                 </svg>
                              </span>
                              <h2 class="mb-20 fs-xl-40 fs-sm-36 tp-text-revel-anim">Achieving success with trusted<span class="text-italic fw-400 tp-ff-heading"> professionals.</span> </h2>
                              <p class="mb-110">Banking consulting content encompasses a wide range topics related to
                                 managing organization's human resources, including recruitment
                                 employee engagement performance management</p>
                              <a href="contact.php" class="tp-btn-xl d-inline-block lh-0 tp-round-26 fs-16 tp-bg-theme-primary ls-0 tp-btn-switch-animation tp-text-common-white hover-text-white fw-500">
                                 <span class="d-flex align-items-center justify-content-center">
               ...
               <div class="tp-contact-area anim-zoomin-wrap pt-140 pb-140 p-relative">
                  <div class="tp-gsap-image-position anim-zoomin fix">
                     <img class="tp-round-4 tp-gsap-image-cover" src="assets/img/contact/bg.jpg" alt="">
                  </div>
                  <div class="container-fluid container-1690">
                     <div class="row">
                        <div class="col-xl-6 col-lg-8">
                           <div class="tp-contact-7-wrap">
                              <h3 class="fw-600 fs-36 ls-m-3 mb-15 tp-text-revel-anim">Join us in collaboration</h3>
                              <p class="tp-text-grey-1 mb-40">Complete the form below, and we'll schedule a consultation<br>
                                 to discuss your business needs</p>
                              <div class="tp-contact-7-form">
                                 <form action="#">
                                    <div class="row">
                                       <div class="col-lg-6 col-md-6 mb-25">
                                          <input class="tp-input" type="text" placeholder="Your full name*">
                                       </div>
                                       <div class="col-lg-6 col-md-6 mb-25">
                                          <input class="tp-input" type="text" placeholder="Email address">
                                       </div>
                                       <div class="col-lg-12 mb-25">
                                          <textarea class="tp-input textarea" placeholder="Write your message"></textarea>
                                          <div class="pt-20">
                                             <button type="submit" class="tp-btn-xl d-inline-block lh-0 tp-round-26 fs-16 tp-bg-theme-primary ls-0 tp-btn-switch-animation tp-text-common-white hover-text-white fw-500">
                                                <span class="d-flex align-items-center justify-content-center">
                  ...
                  <div class="container">
                     <div class="row justify-content-center">
                        <div class="col-xl-5 col-lg-7">
                           <div class="tp-success-6-title-wrap text-center mb-55">
                              <span class="fw-500 fs-16 tp-text-grey-1 mb-10 d-inline-block">Our latest post</span>
                              <h2 class="fs-xl-40 fs-sm-36 tp-text-revel-anim">Read our latest <span class="text-italic fw-400 tp-ff-heading">blog post</span></h2>
                           </div>
                        </div>
                     </div>
                     <div class="row">
                        <div class="col-xl-4 col-lg-6 col-md-6 mb-30 wow fadeInLeft" data-wow-delay=".3s" data-wow-duration=".9s">
                           <div class="tp-blog-2-right-wrap anim-zoomin-wrap tp-blog-6-right-wrap tp-round-4 d-flex align-items-end p-relative">
                              <div class="tp-gsap-image-position anim-zoomin fix">
                                 <img class="tp-round-4 tp-gsap-image-cover" src="assets/img/blog/blog-7/blog.jpg" alt="">
                              </div>
                              <div class="tp-blog-2-content-2">
                                 <div class="tp-blog-2-cetagory mb-20 pt-200">
                                 ...
                                 <h4 class="fw-500 fs-24 lh-34 tp-text-common-white mb-50"><a href="blog-details.php" class="underline-white">Making innovative strategies for
                                    the outstanding future</a></h4>
                                 <a href="blog-details.php" class="tp-blog-7-btn tp-blog-7-btn-left d-inline-block lh-0 tp-round-4 fs-16 tp-bg-common-white ls-0 tp-text-theme-primary hover-text-primary fw-500">
                                    <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                       <path d="M1 9H17" stroke="#1F3130" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                       <path d="M9 1L17 9L9 17" stroke="#1F3130" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                    </svg>
                                 </a>
                              </div>
                           </div>
                        </div>
                        <div class="col-xl-4 col-lg-6 col-md-6 mb-30 wow fadeInUp" data-wow-delay=".3s" data-wow-duration=".9s">
                           <div class="tp-blog-2-right-wrap tp-blog-6-right-wrap tp-blog-7-right-wrap tp-bg-theme-primary tp-round-4">
                              <div class="tp-blog-2-content-2">
                                 <div class="tp-blog-2-cetagory mb-20">
                                    <span class="fw-500 mr-5 tp-text-common-white border-full-1 tp-round-24 d-inline-block">Business</span>
                                    <span class="fw-500 tp-text-common-white border-full-1 tp-round-24 d-inline-block">Corporate</span>
                                 </div>
                                 <h4 class="fw-500 fs-24 lh-34 mb-150 tp-text-common-white"><a href="blog-details.php" class="underline-white">In short, businesses choose
                                    consulting gain expertise</a></h4>
                                 <p class="tp-text-grey-3 mb-30">Our Consultants provide the highest quality
                                    advice and technical support and will
                                    assist your organization</p>
                                 <a href="blog-details.php" class="tp-blog-7-btn d-inline-block lh-0 tp-round-4 fs-16 tp-bg-common-white ls-0 tp-text-theme-primary hover-text-primary fw-500">
                                    <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                       <path d="M1 9H17" stroke="#1F3130" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                       <path d="M9 1L17 9L9 17" stroke="#1F3130" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                    </svg>
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-6 mb-30 wow fadeInRight" data-wow-delay=".3s" data-wow-duration=".9s">
                           <div class="tp-blog-2-right-wrap anim-zoomin-wrap tp-blog-6-right-wrap tp-round-4 d-flex align-items-end p-relative">
                              <div class="tp-gsap-image-position anim-zoomin fix">
                                 <img class="tp-round-4 tp-gsap-image-cover" src="assets/img/blog/blog-7/blog-2.jpg" alt="">
                              </div>
                              <div class="tp-blog-2-content-2">
                                 <div class="tp-blog-2-cetagory mb-20 pt-200">
                                    <span class="fw-500 mr-5 tp-text-common-white border-full-1 tp-round-24 d-inline-block">Business</span>
                                 ...
                                 <h4 class="fw-500 fs-24 lh-34 tp-text-common-white mb-50"><a href="blog-details.php" class="underline-white">Mention the different types of positions available</a></h4>
                                 <a href="blog-details.php" class="tp-blog-7-btn tp-blog-7-btn-left d-inline-block lh-0 tp-round-4 fs-16 tp-bg-common-white ls-0 tp-text-theme-primary hover-text-primary fw-500">
                                    <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                       <path d="M1 9H17" stroke="#1F3130" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                       <path d="M9 1L17 9L9 17" stroke="#1F3130" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
               ...
               <div class="tp-cta-area anim-zoomin-wrap p-relative pt-135 pb-120">
                  <div class="tp-gsap-image-position anim-zoomin fix">
                     <img class="tp-round-4 tp-gsap-image-cover" src="assets/img/cta/bg-6.jpg" alt="">
                  </div>
                  <div class="container">
                     <div class="row">
                        <div class="col-xl-7 col-lg-9">
                           <div class="tp-cta-3-title-wrap mr-100">
                              <h2 class="mb-15 fs-xl-40 fs-sm-36 tp-text-revel-anim">Let’s join hands and make it happen with  <span class="text-italic fw-400 tp-ff-heading">the team!</span> </h2>
                              ...
                              <div class="tp-footer-3-top-content">
                                 <div class="tp-benifits-form-content d-flex align-items-center">
                                    ...
                                    <div class="tp-footer-3-title">
                                       <h3 class="fw-500 fs-30 fs-xs-22 tp-text-common-white mb-5 tp-text-revel-anim">Sign up to our newsletter</h3>
