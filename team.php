   ...
   <body class="tp-bg-common-white-2 tp-magic-cursor">
      ...
      <header class="tp-header-height">
         ...
         <div class="tp-header-area header-transparent tp-header-2-wrap">
            ...
            <div id="header-sticky" class="tp-header-2-main tp-bg-common-white tp-header-lg-space p-relative">
                           ...
                           <div class="tp-main-menu d-none d-xl-block">
                              <nav class="tp-mobile-menu-active">
                                 <ul>
                                    ...
                                    <li><a href="about.php">About</a></li><li class="has-dropdown">
                ...
                <div class="tp-hero-gsap-team-spacing">
                   <div class="tp-breadcrumb-area anim-zoomin-wrap p-relative pt-200">
                      <div class="tp-gsap-image-position anim-zoomin fix">
                         <img class="tp-gsap-image-cover" src="assets/img/breadcrumb/bg-2.jpg" alt="">
                      </div>
                      <div class="container">
                         <div class="row">
                            <div class="col-xl-5 col-lg-6 col-md-9">
                               <div class="tp-breadcrumb-content mr-80">
                                  <h2 class="tp-breadcrumb-title fw-600 fs-60 fs-xs-40 ls-m-3 tp-text-common-white lh-1 text-anim">Our team</h2>
                  ...
                  <div class="container">
                     <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6">
                           <div class="tp-team-2-wrap anim-zoomin-wrap text-center mb-30">
                        ...
                        <div class="col-lg-4 col-md-6">
                           <div class="tp-team-2-wrap anim-zoomin-wrap text-center mb-30">
                              <div class="tp-team-2-thumb fix tp-round-4 mb-25 p-relative">
                                 <div class="anim-zoomin fix">
                                    <img class="w-100 tp-round-4" src="assets/img/team/team-2/thumb-4.jpg" alt="">
                                 </div>
                                 <div class="tp-team-2-social">
                                    <ul class="list-wrap">
                                       <li><a href="#"><i class="fa-brands fa-facebook"></i><span></span></a></li>
                              ...
                              <div class="tp-team-2-content">
                                 <h4 class="fw-500 fs-24 mb-0"><a class="underline-black" href="team-details.php">Nirmal Golam</a></h4>
                                 <span class="tp-text-grey-1">Manager</span>
                              </div>
                           </div>
                        </div>
                        <div class="col-lg-4 col-md-6">
                           <div class="tp-team-2-wrap anim-zoomin-wrap text-center mb-30">
                              <div class="tp-team-2-thumb fix tp-round-4 mb-25 p-relative">
                                 <div class="anim-zoomin fix">
                                    <img class="w-100 tp-round-4" src="assets/img/team/team-2/thumb-5.jpg" alt="">
                                 </div>
                                 <div class="tp-team-2-social">
                                    <ul class="list-wrap">
                                       <li><a href="#"><i class="fa-brands fa-facebook"></i><span></span></a></li>
                              ...
                              <div class="tp-team-2-content">
                                 <h4 class="fw-500 fs-24 mb-0"><a class="underline-black" href="team-details.php">Gucci Flowra</a></h4>
                                 <span class="tp-text-grey-1">Co Founder</span>
                              </div>
                           </div>
                        </div>
                        <div class="col-lg-4 col-md-6">
                           <div class="tp-team-2-wrap anim-zoomin-wrap text-center mb-30">
                              <div class="tp-team-2-thumb fix tp-round-4 mb-25 p-relative">
                                 <div class="anim-zoomin fix">
                                    <img class="w-100 tp-round-4" src="assets/img/team/team-2/thumb-6.jpg" alt="">
                                 </div>
                                 <div class="tp-team-2-social">
                                    <ul class="list-wrap">
                                       <li><a href="#"><i class="fa-brands fa-facebook"></i><span></span></a></li>
                              ...
                              <div class="tp-team-2-content">
                                 <h4 class="fw-500 fs-24 mb-0"><a class="underline-black" href="team-details.php">Ripa Halanad</a></h4>
                                 <span class="tp-text-grey-1">Engineer</span>
                              </div>
                           </div>
                        </div>
                     </div>
