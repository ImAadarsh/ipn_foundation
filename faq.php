         ...
         <div class="tp-hero-gsap-team-spacing">
            <div class="tp-breadcrumb-area anim-zoomin-wrap p-relative pt-200">
               <div class="tp-gsap-image-position anim-zoomin fix">
                  <img class="tp-gsap-image-cover" src="assets/img/breadcrumb/bg-8.jpg" alt="">
               </div>
               <div class="container">
                  <div class="row">
                     <div class="col-xl-6 col-lg-7 col-md-10">
                        <div class="tp-breadcrumb-content mr-80">
                           <h2 class="tp-breadcrumb-title fw-600 fs-60 fs-xs-40 ls-m-3 tp-text-common-white lh-1 text-anim">Our Faq’s</h2>
               ...
               <div class="row">
                  ...
                  <div class="col-xl-8 col-lg-7">
                     ...
                     <div class="tp-faq-check">
                        <h2 class="fw-600 fs-50 fs-lg-40 ls-m-2 mb-50 text-anim">Check others question.</h2>
