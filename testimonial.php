            ...
            <main>
               ...
               <!-- tp-breadcrumb-area-start -->
                <div class="tp-hero-gsap-team-spacing">
                   <div class="tp-breadcrumb-area tanim-zoomin-wrap p-relative fix pt-200">
                      <div class="tp-gsap-image-position anim-zoomin fix">
                         <img class="tp-gsap-image-cover" src="assets/img/breadcrumb/bg-7.jpg" alt="">
                      </div>
                      <div class="container">
                         <div class="row">
                            <div class="col-xl-6 col-lg-7 col-md-10">
                               <div class="tp-breadcrumb-content mr-80">
                                  <h2 class="tp-breadcrumb-title fw-600 fs-60 fs-xs-40 ls-m-3 text-anim tp-text-common-white lh-1">Testimonials</h2>
               ...
               <!-- tp-testimonial-author-area-start -->
               <div class="tp-testimonial-author-area pt-120 pb-110">
                  <div class="container">
                     <div class="row align-items-center">
                        <div class="col-lg-5">
                           <div class="tp-testimonial-author-thumb p-relative mb-30">
                              <div class="image-reveal fix">
                                 <img class="tp-round-4" src="assets/img/testimonial/details/thumb.png" alt="">
                              </div>
                              <div class="tp-testimonial-author-clients text-center">
                                 <div class="d-flex align-items-center justify-content-center mb-5">
                                    <img class="mr-10" src="assets/img/testimonial/details/avatar.png" alt="">
                                    <h2 class="fw-700 fs-44 ls-m-3 text-uppercase mb-0"><span data-purecounter-duration="1" data-purecounter-end="39"  class="purecounter">0</span>K</h2>
                                 </div>
                                 <span class="fw-500 fs-17 ls-m-4 tp-text-grey-1"><i class="fa-solid fa-star tp-text-common-yellow mr-5"></i> Successful business clients </span>
                              </div>
                           </div>
                        </div>
                        <div class="col-lg-7">
                           <div class="tp-testimonial-author-content ml-110 mb-30">
                              <span class="tp-section-subtitle fw-500 tp-text-grey-1 mb-10"> Our industries </span>
                              <h2 class="mb-20 fs-xl-40 fs-sm-36 text-anim">We ready to help achieve<br> your  <span class="text-italic fw-400 tp-ff-heading">mutual goals</span></h2>
                              <p class="mb-50">HR consulting content encompasses a wide range of topics related to managing
                              ...
                              <div class="tp-testimonial-author d-flex align-items-center">
                                 <div class="d-flex align-items-center mr-20">
                                    <img src="assets/img/testimonial/details/user.png" alt="">
                                    <a class="tp-testimonial-author-social" href="#"><i class="fa-brands fa-facebook-f"></i></a>
                                 </div>
                                 <span class="fw-600 fs-600 fs-18 ls-m-2 tp-text-grey-1">Harshal Mitra</span>
                              </div>
                           </div>
                        </div>
                     </div>
               ...
               <!-- tp-testimonial-author-area-end -->
