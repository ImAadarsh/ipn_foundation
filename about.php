                         ...
                         <div class="row">
                            <div class="col-xl-5 col-lg-6 col-md-9">
                               <div class="tp-breadcrumb-content mr-80">
                                  <h2 class="tp-breadcrumb-title fw-600 fs-60 fs-xs-40 ls-m-3 tp-text-common-white lh-1 text-anim">About us</h2>
               ...
               <div class="tp-industry-area pt-135 pb-110">
                  <div class="container">
                     ...
                     <div class="row">
                        ...
                        <div class="col-xl-3 col-lg-6 col-md-6">
                           <div class="tp-industry-content d-flex align-items-center tp-round-4 mb-30 wow fadeInLeft" data-wow-delay=".8s" data-wow-duration=".9s">
                              <span class="tp-industry-icon d-inline-block tp-text-theme-primary">
                                 <svg width="44" height="44" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg">
                     ...
                     <div class="row justify-content-center">
                        <div class="col-xl-9">
                           <div class="row justify-content-center">
                              ...
                              <div class="col-xl-4 col-lg-6 col-md-6">
                                 <div class="tp-industry-content d-flex align-items-center tp-round-4 mb-30 wow fadeInLeft" data-wow-delay=".9s" data-wow-duration=".9s">
                                    <span class="tp-industry-icon d-inline-block tp-text-theme-primary">
                                       <svg width="44" height="44" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg">
               ...
               <div class="tp-team-area pt-135 pb-100">
                  <div class="container">
                     <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6">
                           <div class="tp-team-2-wrap anim-zoomin-wrap text-center mb-30 wow fadeInRight" data-wow-delay=".3s" data-wow-duration=".9s">
                              <div class="tp-team-2-thumb fix tp-round-4 mb-25 p-relative">
                                 <div class="anim-zoomin fix">
                           ...
                           <div class="row">
                              <div class="col-12">
                                 <div class="tp-footer-bottom-copyright text-center">
                                    <p class="tp-text-border-3 mb-0 lh-22">© <span id="year"></span> <a href="#" class="tp-text-common-white">IPN Foundation</a>. All Rights Reserved. Developed by <a href="https://endeavourdigital.in" class="tp-text-common-white">Endeavour Digital</a></p>
                                 </div>
                              </div>
                           </div>
                        </div>
