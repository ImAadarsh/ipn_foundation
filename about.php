                ...
                <div class="tp-hero-gsap-team-spacing">
                   <div class="tp-breadcrumb-area anim-zoomin-wrap p-relative pt-200">
                      <div class="tp-gsap-image-position anim-zoomin fix">
                         <img class="tp-gsap-image-cover" src="assets/img/breadcrumb/bg.jpg" alt="">
                      </div>
                      <div class="container">
                         <div class="row">
                            <div class="col-xl-5 col-lg-6 col-md-9">
                               <div class="tp-breadcrumb-content mr-80">
                                  <h2 class="tp-breadcrumb-title fw-600 fs-60 fs-xs-40 ls-m-3 tp-text-common-white lh-1 text-anim">About IPN Foundation</h2>
                  ...
                  <div class="container-fluid container-1690 p-relative">
                     ...
                     <div class="row align-items-center">
                        ...
                        <div class="col-lg-4 col-md-7 mb-30">
                           <div class="tp-about-4-thumb mr-70">
                           ...
                           <div class="col-lg-5 col-md-7">
                              <div class="tp-chose-middle-content">
                                 <div class="tp-chose-middle-title">
                                    ...
                                    <h4 class="fw-500 fs-26 mb-55 lh-30 br">Why choose IPN Foundation?</h4>
                                 </div>
                                 <a href="contact.php" class="fw-500 tp-text-theme-primary tp-bg-common-white fs-16 d-flex justify-content-between">Join our global network
                                    <span>
                     ...
                     <div class="row">
                           ...
                           <div class="tp-chose-wrapper pb-50">
                              ...
                              <div class="tp-chose-work">
                                 <div class="d-flex align-items-center">
                                    <h2 class="fs-60 tp-text-common-white mr-30">45+</h2>
                                    <p class="tp-text-grey-3">Countries in our global network</p>
                                 </div>
                                 <div class="d-flex align-items-center">
                                    <h2 class="fs-30 tp-text-common-white mr-30 d-flex justify-content-start"><span class="fs-60">12,000</span>+</h2>
                                    <p class="tp-text-grey-3">School leaders connected</p>
                                 </div>
                              </div>
                           </div>
                        </div>
                        <div class="col-lg-5">
                           <div class="tp-chose-content">
                              <p class="tp-text-grey-3 mb-25">IPN Foundation brings together visionary school leaders, educators, and partners to drive educational innovation, share best practices, and create lasting impact in the education sector.</p>
                              <p class="tp-text-grey-3 mb-70">Our programs focus on leadership development, teacher empowerment, and student growth, making us a trusted partner for schools and organizations worldwide.</p>
                              <a href="contact.php" class="tp-btn-lg d-inline-block lh-0 tp-round-24 fs-16 tp-bg-common-white ls-0 tp-btn-switch-animation tp-text-theme-primary hover-text-primary fw-500 mb-10">
                                 <span class="d-flex align-items-center justify-content-center">
                                    <span class="btn-text"> Learn more about our impact</span>
                                    <span class="btn-icon"><i class="fa-sharp fa-regular fa-arrow-right"></i></span>
                                    <span class="btn-icon"><i class="fa-sharp fa-regular fa-arrow-right"></i></span>
                                 </span> 
                              </a>
                     ...
                     <div class="row justify-content-center">
                        <div class="col-lg-6 col-md-8">
                           <div class="tp-industry-section-title-wrap text-center mb-50">
                              <span class="fw-500 fs-16 tp-text-grey-1 mb-5 d-inline-block">Our focus areas</span>
                              <h2 class="mb-20 fs-xl-40 fs-sm-36 text-anim">How we <span class="text-italic fw-400 tp-ff-heading">transform education</span></h2>
                           </div>
                        </div>
                     </div>
                     <div class="row">
                        <div class="col-xl-3 col-lg-6 col-md-6">
                           <div class="tp-industry-content d-flex align-items-center tp-round-4 mb-30 wow fadeInLeft" data-wow-delay=".3s" data-wow-duration=".9s">
                              ...
                              <div class="border-right"></div>
                              <h5 class="fw-500 fs-18 mb-0 ml-25 pt-10 pb-10 pr-10">Teacher Training<br> & Empowerment</h5>
                           </div>
                        </div>
                        <div class="col-xl-3 col-lg-6 col-md-6">
                           <div class="tp-industry-content d-flex align-items-center tp-round-4 mb-30 wow fadeInLeft" data-wow-delay=".7s" data-wow-duration=".9s">
                              <span class="tp-industry-icon d-inline-block tp-text-theme-primary">
                                 <svg width="45" height="45" viewBox="0 0 45 45" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <path d="M36.809 25.6757C36.4757 18.209 30.2757 12.1423 22.6757 12.1423C16.2757 12.1423 10.8757 16.409 9.14234 22.209C9.07568 22.2757 9.07568 22.3423 9.07568 22.4757C8.80901 23.4757 8.60901 24.5423 8.60901 25.609V25.6757V25.809V26.2757C8.60901 29.809 9.94234 33.0757 12.1423 35.5423L12.209 35.609C12.209 35.609 12.2757 35.609 12.2757 35.6757C12.9423 36.409 13.6757 37.1423 14.5423 37.6757V37.7423C14.609 37.809 14.6757 37.8757 14.7423 37.8757C17.009 39.4757 19.809 40.409 22.7423 40.409C25.809 40.409 28.609 39.409 30.9423 37.7423C31.7423 37.1423 32.5423 36.4757 33.209 35.6757C33.209 35.6757 33.2757 35.6757 33.2757 35.609C33.3423 35.5423 33.3423 35.5423 33.3423 35.4757C35.4757 33.009 36.809 29.7423 36.809 26.209C36.809 26.0757 36.809 25.8757 36.809 25.7423C36.809 25.809 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757C36.809 25.7423 36.809 25.7423 36.809 25.6757