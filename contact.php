            ...
            <main>
                     ...
                     <div class="row">
                        <div class="col-lg-9 col-md-6">
                           <div class="tp-contact-title-wrap mb-30">
                              <span class="fw-500 fs-16 tp-text-grey-1 mb-5 d-inline-block"> Connect with us</span>
                              <h3 class="mb-20 fs-xl-40 fs-sm-36 text-anim">Empowering School Leaders,<br> <span class="text-italic fw-400 tp-ff-heading">Transforming Education</span></h3>
                              <div class="tp-contact-tag pt-90">
                                 <a href="#">Lucknow (HQ)</a>
                                 <a href="#">Navi Mumbai (Academy)</a>
                                 <a href="#">Global Chapters</a>
                              </div>
                           </div>
                        </div>
                           ...
                           <div class="tp-contact-main-info mb-30">
                              <div class="d-flex align-items-center mb-20">
                                 ...
                                 <div>
                                    ...
                                    <a href="tel:+918400700199" class="fw-600 fs-16 ls-m-2 tp-text-theme-primary underline-black">+91-8400700199</a>
                                 </div>
                              </div>
                              <div class="d-flex align-items-center mb-20">
                                 <span class="tp-contact-main-icon mr-15">
                                 ...
                                 <div>
                                    ...
                                    <a href="mailto:team@ipnfoundation.org" class="fw-600 fs-16 ls-m-2 tp-text-theme-primary underline-black">team@ipnfoundation.org</a>
                                 </div>
                              </div>
                              <div class="d-flex align-items-center mb-20">
                                 <span class="tp-contact-main-icon mr-15">
                              ...
                              <div class="d-flex align-items-center mb-20">
                                 ...
                                 <div>
                                    <a href="mailto:ipnacademy@ipnindia.in" class="fw-600 fs-16 ls-m-2 tp-text-theme-primary underline-black">ipnacademy@ipnindia.in (Academy)</a>
                                 </div>
                              </div>
                              <div class="d-flex align-items-center mb-20">
                                 <span class="tp-contact-main-icon mr-15">
                                 ...
                                 <div>
                                    <a href="https://www.ipnfoundation.org" target="_blank" class="fw-600 fs-16 ls-m-2 tp-text-theme-primary underline-black">ipnfoundation.org</a>
                                 </div>
                              </div>
                           </div>
                        </div>
                                 ...
                                 <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                       <div class="tp-contact-slider-thumb tp-round-4 p-relative bg-position not-hide-cursor" data-cursor="Drag" data-background="assets/img/contact/thumb.jpg">
                                          <h4 class="fs-30 ls-m-3 tp-text-common-white mb-10">118, 2nd Floor, Sadar Bazaar Cantt Market,<br> Near ICICI Bank, Lucknow, Uttar Pradesh, 226002, India</h4>
                                          ...
                                          <div class="tp-contact-office-email d-flex align-items-center">
                                             ...
                                             <span>
                                                <a href="mailto:team@ipnfoundation.org" style="color:white;">team@ipnfoundation.org</a>
                                             </span>
                                          </div>
                                       </div>
                                    </div>
                                    <div class="swiper-slide">
                                       <div class="tp-contact-slider-thumb tp-round-4 p-relative bg-position not-hide-cursor" data-cursor="Drag" data-background="assets/img/contact/thumb-2.jpg">
                                          <h4 class="fs-30 ls-m-3 tp-text-common-white mb-10">Raj Palace CHS Limited Sector 02,<br> Kopar Khairane, Navi Mumbai - 400709, India</h4>
                                          <span class="fw-600 fs-14 ls-m-2 tp-text-common-white d-inline-block mb-20">Monday - Friday 10 a.m. - 6 p.m.</span>
                                          <div class="tp-contact-office-email d-flex align-items-center">
                                             <span class="tp-text-common-white fw-700 fs-12 text-uppercase">ACADEMY EMAIL</span>
                                             <span class="tp-contact-email-border"></span>
                                             <span>
                                                <a href="mailto:ipnacademy@ipnindia.in" style="color:white;">ipnacademy@ipnindia.in</a>
                                             </span>
                                          </div>
                                       </div>
                                    </div>
                                    <div class="swiper-slide">
                                       <div class="tp-contact-slider-thumb tp-round-4 p-relative bg-position not-hide-cursor" data-cursor="Drag" data-background="assets/img/contact/thumb-3.jpg">
                                          <h4 class="fs-30 ls-m-3 tp-text-common-white mb-10">Global Chapters<br> (See website for details)</h4>
                                          <span class="fw-600 fs-14 ls-m-2 tp-text-common-white d-inline-block mb-20">Worldwide Network</span>
                                          <div class="tp-contact-office-email d-flex align-items-center">
                                             <span class="tp-text-common-white fw-700 fs-12 text-uppercase">WEBSITE</span>
                                             <span class="tp-contact-email-border"></span>
                                             <span>
                                                <a href="https://www.ipnfoundation.org" style="color:white;">ipnfoundation.org</a>
                                             </span>
                                          </div>
                                       </div>
                                    </div>
                           ...
                           <div class="mb-30">
                              ...
                              <div class="tp-contact-bottom-social">
                                 <ul class="d-flex align-items-center">
                                    <li>
                                       <a href="https://www.facebook.com/IPNFoundationIndia" target="_blank">
                                          <i class="fa-brands fa-facebook-f"></i>
                                       </a>
                                    </li>
                                    <li>
                                       <a href="https://www.instagram.com/ipn_foundation/" target="_blank">
                                          <i class="fa-brands fa-instagram"></i>
                                       </a>
                                    </li>
                                    <li>
                                       <a href="https://www.linkedin.com/company/ipn-indian-principal-s-network" target="_blank">
                                          <i class="fa-brands fa-linkedin-in"></i>
                                       </a>
                                    </li>
                                    <li>
                                       <a href="https://x.com/ipnfoundation?lang=en" target="_blank">
                        ...
                        <div class="col-lg-8">
                           <div class="tp-join-form-wra tp-contact-inner-wrap mb-30">
                              <form id="contact-form" action="assets/mail.php" method="POST">
                                 ...
                                 <input class="tp-input mb-15" name="website" type="text" placeholder="Your organization or school*">
                                 <textarea name="message" class="tp-textarea tp-input mb-10" placeholder="How can we help? Feel free to write here"></textarea>
               ...
               <div class="tp-map-area fix lh-1">
                  <div class="tp-contact-map-box">
                     <iframe src="https://www.google.com/maps?q=118,+2nd+Floor,+Sadar+Bazaar+Cantt+Market,+Near+ICICI+Bank,+Lucknow,+Uttar+Pradesh,+226002,+India&output=embed" height="535" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                  </div>
               </div>
               <!-- map area end  -->
