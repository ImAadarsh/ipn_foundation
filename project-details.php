      ...
      <div id="smooth-wrapper">
         <div id="smooth-content">
            ...
            <main>
               ...
               <div class="tp-hero-gsap-team-spacing">
                  <div class="tp-breadcrumb-area anim-zoomin-wrap p-relative pt-200">
                     <div class="tp-gsap-image-position anim-zoomin fix">
                        <img class="tp-gsap-image-cover" src="assets/img/breadcrumb/bg-10.jpg" alt="">
                     </div>
                     <div class="container">
                        <div class="row">
                           <div class="col-xl-6 col-lg-7 col-md-10">
                              <div class="tp-breadcrumb-content mr-80">
                                 <h2 class="tp-breadcrumb-title fw-600 fs-60 fs-xs-40 ls-m-3 tp-text-common-white lh-1 text-anim">Project details</h2>
               ...
               <div class="tp-project-details-area pt-140">
                  <div class="container">
                     <div class="row">
                        <div class="col-lg-12">
                           <div class="tp-project-details-content">
                              <div class="tp-project-details-thumb wow img-custom-anim-top" data-wow-duration="1.5s" data-wow-delay="0.2s">
                                 <img class="w-100" src="assets/img/project/details/thumb.jpg" alt="">
                              </div>
                              <div class="tp-project-details-info">
                                 <div class="tp-project-details-info-item mr-115 mb-30">
                                    <span class="fw-500 fs-16 tp-text-grey-1 mb-5 d-block">Clients:</span>
                                    <a href="#" class="fw-500 fs-18 ls-m-3 tp-text-theme-primary">Microsoft Holing Ltd,<br> Australia Area</a>
                                 </div>
                                 <div class="tp-project-details-info-item mr-115  mb-30">
                                    <span class="fw-500 fs-16 tp-text-grey-1 mb-5 d-block">Service:</span>
                                    <a href="#" class="fw-500 fs-18 ls-m-3 tp-text-theme-primary">Design, Branding, Apps<br> Development</a>
                                 </div>
                                 <div class="tp-project-details-info-item mr-115  mb-30">
                                    <span class="fw-500 fs-16 tp-text-grey-1 mb-5 d-block">Date:</span>
                                    <a href="#" class="fw-500 fs-18 ls-m-3 tp-text-theme-primary">February 23, 2025<br> release started</a>
                                 </div>
                                 <div class="tp-project-details-info-item  mb-30">
                                    <span class="fw-500 fs-16 tp-text-grey-1 mb-5 d-block">Website:</span>
                                    <a href="#" class="tp-btn-lg d-inline-block lh-0 tp-round-24 fs-16 mb-20 tp-bg-theme-primary ls-0 tp-btn-switch-animation tp-text-common-white hover-text-white fw-500">
                                       <span class="d-flex align-items-center justify-content-center">
                              ...
                              <div class="tp-project-details-content pt-90 pb-30">
                                 <h2 class="fs-40 fw-600 ls-m-2 mb-20 text-anim">Duis aute irure dolor in reprehenderit</h2>
                                 <p class="fs-18">There are some cases in which consultants can also make processes much  faster. Especially when a team is building a new campaign or business  plan, a consultant can come in with clear steps and assignments right  away. Many also have a strong network of service providers and external  resources. Each type of consulting service addresses a specific aspect of a  business’s operations or management. From shaping high-level business  strategies to optimizing day-to-day practices, consultants bring a wide  variety of impactful perspectives and solutions to entrepreneurs and  their teams.</p>
                              </div>
                              <div class="tp-project-details-list mb-90">
                                 <h2 class="fs-40 fw-600 ls-m-2 mb-15 text-anim">Overview</h2>
                                 <ul class="mb-20">
                                 ...
                                 <p class="fs-18">Strategic planning consultants specialize in helping organizations  define their vision, mission and long-term goals. They often create  comprehensive plans that outline the steps a team should take to achieve their objectives. In doing so, they assist with aligning resources,  setting priorities and establishing measurable targets. Operations consultants are all about efficiency.</p>
                              </div>
                              <div class="tp-project-details-thumb-wrap">
                                 <div class="row">
                                    <div class="col-lg-5">
                                       <div class="tp-project-details-thumb anim-zoomin-wrap mb-30">
                                          <div class="anim-zoomin fix">
                                             <img class="w-100" src="assets/img/project/details/thumb-2.jpg" alt="">
                                          </div>
                                       </div>
                                    </div>
                                    <div class="col-lg-7">
                                       <div class="tp-project-details-thumb anim-zoomin-wrap mb-30">
                                          <div class="anim-zoomin fix">
                                             <img class="w-100" src="assets/img/project/details/thumb-3.jpg" alt="">
                                          </div>
                                       </div>
                                    </div>
                                 </div>
               ...
               <!-- tp-faq-area-start -->
               <div class="tp-faq-area pt-110 pb-70">
                  <div class="container">
                     <div class="row">
